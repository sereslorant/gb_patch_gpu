...
std::string TeShaderSrc = R"(
    ...
    void main()
    {
        ...
        OutColor = vec3(SideCoords[0].x,SideCoords[0].y,0.0);
        //OutColor = vec3(SideCoords[1].x,SideCoords[1].y,0.0);
        //OutColor = vec3(SideCoords[2].x,SideCoords[2].y,0.0);
        //OutColor = vec3(SideCoords[3].x,SideCoords[3].y,0.0);
        //OutColor = vec3(SideCoords[4].x,SideCoords[4].y,0.0);
